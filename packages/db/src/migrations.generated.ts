...
`,
  ...
  {
    name: "0007_more_channels.sql",
    sql: `-- Slack and LINE join the channels a business can connect from the panel.
--
...
`,
  ...
  {
    name: "0008_trigram.sql",
    sql: `-- Trigram matching, for the words a language's grammar bends.
--
...
`,
  ...
  {
    name: "0009_provider_configs.sql",
    sql: `-- Per-tenant AI provider credentials.
--
